...
> Historical note: this validation note is archived for reference. It may
> mention output directories or code paths that were later reorganized.
...
- `/data1/wangchen/projects/TraceForge/data_tmp/history_outputs/outputs_press_one_button_demo_v1_extrinsics_compare_2026-03-12`
