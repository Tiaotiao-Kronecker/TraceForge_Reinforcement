...
> Historical note: this branch note is archived. Paths and follow-up links may
> have moved into `docs/history/`.
...
- `camera_extrinsics_fix_validation_2026-03-12.md`
- `camera_extrinsics_old_flow_example_2026-03-12.md`
- `droid_h5_w2c_single_case_validation_2026-03-12.md`
